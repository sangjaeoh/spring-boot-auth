...
/**
 * app-migration 멀티스키마 검증: 기동 시 SchemaFlywayFactory가 설정된 스키마들을 각자 독립 Flyway로 마이그레이션한다.
 *
...
class MigrationApplicationIT {
    ...
    void migratesAllConfiguredSchemasWithIndependentHistories() throws Exception {
        ...
        assertTableExists("generic", "notification");
        ...
        assertTableExists("generic", "flyway_schema_history");
    }
